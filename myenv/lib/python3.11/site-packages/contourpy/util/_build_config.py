...
def build_config() -> dict[str, str]:
    ...
    return dict(
        ...
        # Misc meson settings
        meson_backend="ninja",
        build_dir=r"/tmp/pip-wheel-dp3ktvzd/contourpy_bc94c35d72da4e0891ff3027635555b8/.mesonpy-lz1_zm50/lib/contourpy/util",
        source_dir=r"/tmp/pip-wheel-dp3ktvzd/contourpy_bc94c35d72da4e0891ff3027635555b8/lib/contourpy/util",
        cross_build="False",

        # Build options
        build_options=r"-Dbuildtype=release -Db_ndebug=if-release -Db_vscrt=md -Dvsenv=True --native-file=/tmp/pip-wheel-dp3ktvzd/contourpy_bc94c35d72da4e0891ff3027635555b8/.mesonpy-lz1_zm50/meson-python-native-file.ini",
        buildtype="release",
        cpp_std="c++17",
        debug="False",
        optimization="3",
